 ...
 */
public class AnswerSheetFragmt extends Fragment implements CommonRecyclerViewAdapter.onItemClickListener {
    public static final String TAG = "AnswerSheetFragmt";
...
//        if (myEvent.eventType == AnswerSheetFragmt.TAG) {
//            //处理各个页面提交的结果
...
//        }
        ...
        //填空题页面发过来的事件
        if (myEvent.eventType == AnswerSheetFragmt.FROM_FILLBLANK) {
